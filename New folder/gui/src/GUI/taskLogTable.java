 ...
 * @author 10
 */
public class taskLogTable extends javax.swing.JFrame {

    /**
     * Creates new form tasksTable
     */
    public taskLogTable() {
        super("Admin UI [taskLogTable]");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ttasklog = new javax.swing.JTable();
        ...
        ttasklog.setBackground(new java.awt.Color(51, 51, 51));
        ttasklog.setBorder(new javax.swing.border.MatteBorder(null));
        ttasklog.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ttasklog.setForeground(new java.awt.Color(204, 204, 204));
        ttasklog.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Task Code", "Task Title", "Description", "Assigned Employee", "ActualTime"
            }
        ) {
        ...
        jScrollPane1.setViewportView(ttasklog);
    ...
    private void read4task(){
        ...
        try {
            String sql = "SELECT * FROM tasklog WHERE TaskCode = ? ";
            ps = con.prepareStatement(sql);
            ps.setString(1, tasklog);
            rs = ps.executeQuery();
            while (rs.next()) {
                String code = String.valueOf(rs.getInt("TaskCode"));
                String taskTitle = rs.getString("TaskTitle");
                String des = rs.getString("Description");
                String assEmp = String.valueOf(rs.getInt("AssignedEmployee"));
                String AcTime = rs.getString("ActualTime");
                
                // 2 show in table
                String dataTable[] = {code,taskTitle,des,assEmp,AcTime};
                DefaultTableModel dtm1 = (DefaultTableModel)ttasklog.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(taskLogTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new taskLogTable().setVisible(true);
        });
    }
    ...
    private javax.swing.JTable ttasklog;
